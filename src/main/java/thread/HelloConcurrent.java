...
//        runDAfterABC();
    ...
    /**
     * 子线程传值给主线程，调用get会阻塞主线程
     */
    private static void doTaskWithResultInWorker() throws ExecutionException, InterruptedException {
        //创建线程池
        ...
        System.out.println( futureTask.get()+" ---------");//调用get会阻塞主线程
     ...
     * A,B,C  countDownLatch.countDown();后
     * 换起 countDownLatch.await(); D
     */
